...
As you fill in the details, the form shows a live preview:

- You receive today: $X,XXX.XX (funded amount at current pool discount rate)
- Buyer repays: $X,XXX.XX on [due date]
- Your cost: $XX.XX

### Step 2 — Review and sign

Check the summary screen. Once you sign with Freighter, the invoice is created
